...
const CreatePost = () => {
    ...
    return (
        <div className='border-l-2 border-r-2 border-gray-300 border-opacity-50'>
            ...
            <div class="flex">
                ...
                <div class="w-64 px-2">
                    ...
                    <div class="flex items-center">
                        <div onClick={() => handleImageUrl()} class="flex-1 text-center px-1 py-1 m-2">
                ...
                <div class="flex-1">
                    <button onClick={() => sendPost()} class="bg-blue-400 mt-5 hover:bg-blue-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                        Post
                    </button>
                </div>
            </div>
